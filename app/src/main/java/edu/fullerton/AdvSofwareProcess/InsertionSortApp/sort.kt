...
class sort : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        add!!.setOnClickListener{
            ...
            if(input == ""){
                Toast.makeText(this, "Missing Input Numbers", Toast.LENGTH_LONG).show()

            }
            else{
            Toast.makeText(this, Condition_add(input.toInt()), Toast.LENGTH_LONG).show()
            }
            adapter.notifyDataSetChanged() // this is the internal function use for notify the list change and update layout
